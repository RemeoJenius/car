...
<body>
    ...
    <!-- knob -->
    <script src="/car/admin/js/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="/car/admin/js/jquery.flot.js"></script>
    <script src="/car/admin/js/jquery.flot.stack.js"></script>
    <script src="/car/admin/js/jquery.flot.resize.js"></script>
    <!-- morrisjs -->
    <script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <script src="/car/admin/js/morris.min.js"></script>
    <!-- call all plugins -->
