...
<head>
    ...
    <link rel="stylesheet" href="/car/user/css/style.css">

    <link rel="stylesheet" href="/car/user/css/iconfont.css">

    <script src="/car/user/js/jquery.js"></script>
    <script src="/car/user/js/vue1.js"></script>
    <script src="/car/user/js/reqwest.js"></script>
        ...
        <div class="box-con tran">
            ...
            <div class="login-con f-l">
                ...
                <div class="form-group">
                    ...
                    <input v-model="username" name="username" type="text" placeholder="手机号码/邮箱" />

                    <span id="username-error" class="error-notic">用户不存在</span>
                ...
                <div class="form-group">
                    ...
                    <span id="password-error" class="error-notic">{{error.message}}}</span>

                </div>

                <div class="form-group">

                    <button v-on:click="submit()" type="submit" class="tran pr">

						<a href="javascript:;" class="tran">登录</a>

						<img v-if="show.login" class="loading" src="/car/user/images/loading.gif" style="display:block">
                ...
                <div class="form-group">
                    ...
                    <a href="javascript:;" class="signup-select move-signup a-tag tran blue-border  ">还没有帐号？免费注册<i class="iconfont tran">&#xe606;</i></a>
            ...
            <div class="signup f-l">
                ...
                <div class="form-group">
                    ...
                    <div id="mail" class="signup-form">

                        <input v-model="mail" type="text" placeholder="邮箱" class="email-mobile" onblur="verify.verifyEmail(this)">
                ...
                <div class="signup-email">
                    ...
                    <div class="form-group">
                        ...
                        <input id="mailpassword" v-model="mailpassword" type="password" placeholder="密码（字母、数字，至少6位）" onblur="verify.PasswordLenght(this)">

                        <span class="error-notic">密码长度不够</span>

                    </div>
                    <div id="mailcheck" class="form-group">

                        <input v-model="code" type="text" placeholder="您收到的邮箱验证码">

                    </div>

                    <div class="form-group">

                        <button v-on:click="registered()" type="submit" class="tran pr">

							<a href="javascript:;" class="tran">注册</a>

							<img v-if="show.registered" class="loading" src="/car/user/images/loading.gif">

						</button>
                        <span id="registered-error" class="error-notic">{{error.message}}</span>
    ...
    <script>
        var vm = new Vue({
            ...
            methods: {
                ...
                registered: function() {
                    this.show.registered = true;
                    console.log(this.show.registered)
                    var self = this;
                    console.log("【验证码】" + self.code);
                    reqwest({
                        url: "/car/user/registered/mail",
                        type: "json",
                        method: "post",
                        data: {
                            'mail': self.mail,
                        ...
                        success: function(root) {
                            console.log(root);
                            self.error.message = root.msg;
                            if (root.code == 3) {
                                $("#registered-error").show();
                                return;
                            }
                            if (root.code == 4) {
                                $("#registered-error").show();
                            ...
                            if (root.code == 0 && self.code != null) {
                                self.error.message = "注册成功";
                                $('#mail').show();
                                $('#mailpassword').show();
                                $("#mailcheck").hide()
                                return;
                            }
                            if (root.coder == 0 && root.data != null) {
                                alert(root.data);
                                return;
                            }
                            self.show.registered = false;
